        ...
        <section className={styles.section}>
            <div className='container'>
                ...
                <div className="md:flex items-center justify-between mb-10 xl:mb-20">
                    <div className="md:w-8/12 xl:w-7/12 font-darker text-25 xl:text-34 text-gray-01 text-center md:text-left">
                        <p className="mb-10">Every month, One Lucky Duck gets free swag shipped to their doorstep, wherever in the world you are! All you have to do is join our Discord channel today and tweet about the amazing things we do. #nullcast #luckyduck</p>
