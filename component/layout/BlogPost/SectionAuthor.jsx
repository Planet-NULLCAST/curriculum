      ...
      <div className="container container--post">
        ...
        <div className={styles.widget}>
          ...
          <div className={styles.description}>
            ...
            {!bio && (
              <p>
                ML data annotations made super easy. Just upload data, invite
                your team and build training/evaluation dataset in hours.ML data
                annotations made super easy. Just upload data, invite your team.
              </p>
            )}
          </div>
        </div>
