...
export default function BlogPost() {
    return (
        ...
        <style jsx>{`
            ...
            .bg1 {
                background: #282828; color: #fff; padding: 80px 0; position: relative;
            }
            .bg1:before, .bg1:after{
                background: #282828; content: ''; position: absolute; z-index: -1; width: 100vw; height: 100%;
                top: 0; 
            }
            .bg1:before { right: 0; }
            .bg1:after { left: 0; }
                    ...
                    <div className={styles.widget}>
                        <div className={styles.index}>
                            ...
                            <ol>
                                ...
                                <li>
                                    <Link href="#post2">
                                        <a className="linkUnderline">Why do we need null safety?</a>
                                    </Link>
                                </li>
                                <li>
                                    <Link href="#post3">
                                        <a className="linkUnderline">Declaring Non-Nullable Variables</a>
                                    </Link>
                                </li>
                            </ol>
                        </div>
                        <div className={styles.social}>
                            ...
                            <ul>
                                <li>
                                    <Link href="">
                                        <a rel="noopener"><svg width="7" height="16" viewBox="0 0 7 16" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M5.722 2.657H7V.113C6.78.078 6.021 0 5.138 0 3.296 0 2.033 1.325 2.033 3.76V6H0v2.844h2.033V16h2.493V8.845h1.951L6.787 6H4.526V4.04c0-.822.194-1.384 1.196-1.384z" fill="#757575"/></svg></a>
                                    </Link>
                                </li>
                                <li>
                                    <Link href="">
                                        <a rel="noopener"><svg width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M16.535 15.627h.004V9.896c0-2.804-.604-4.964-3.882-4.964-1.575 0-2.633.865-3.065 1.684h-.045V5.194H6.439v10.433h3.236V10.46c0-1.36.258-2.676 1.942-2.676 1.66 0 1.685 1.553 1.685 2.763v5.08h3.233zM1.17 5.194h3.24v10.433H1.17V5.194zM2.788 0C1.752 0 .911.84.911 1.877c0 1.036.841 1.894 1.877 1.894s1.877-.858 1.877-1.894A1.878 1.878 0 002.788 0z" fill="#757575"/></svg></a>
                                    </Link>
                                </li>
                                <li>
                                    <Link href="">
                                        <a rel="noopener"><svg width="19" height="16" viewBox="0 0 19 16" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M18.413 2.589c-.685.3-1.414.5-2.175.596a3.752 3.752 0 001.66-2.086 7.541 7.541 0 01-2.392.914 3.772 3.772 0 00-6.528 2.58c0 .3.025.587.087.86a10.681 10.681 0 01-7.778-3.947 3.8 3.8 0 00-.516 1.908A3.78 3.78 0 002.447 6.55a3.727 3.727 0 01-1.705-.465v.042a3.791 3.791 0 003.023 3.707 3.766 3.766 0 01-.99.125c-.24 0-.485-.014-.714-.065a3.81 3.81 0 003.527 2.629 7.582 7.582 0 01-4.68 1.61 7.08 7.08 0 01-.902-.052 10.624 10.624 0 005.789 1.693c6.944 0 10.74-5.752 10.74-10.738a9.69 9.69 0 00-.014-.488 7.529 7.529 0 001.892-1.96z" fill="#757575"/></svg></a>
                                    </Link>
                                </li>
                                <li>
                                    <Link href="">
                                        <a rel="noopener"><svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M11.116 0h-5.86A4.884 4.884 0 00.373 4.884v5.86a4.884 4.884 0 004.883 4.883h5.86A4.884 4.884 0 0016 10.744v-5.86A4.884 4.884 0 0011.116 0zm3.419 10.744a3.422 3.422 0 01-3.419 3.418h-5.86a3.422 3.422 0 01-3.418-3.418v-5.86a3.422 3.422 0 013.418-3.419h5.86a3.422 3.422 0 013.419 3.419v5.86z" fill="#757575"/><path d="M8.186 3.907a3.907 3.907 0 100 7.814 3.907 3.907 0 000-7.814zm0 6.349a2.445 2.445 0 01-2.441-2.442 2.445 2.445 0 012.441-2.442 2.445 2.445 0 012.442 2.442 2.445 2.445 0 01-2.442 2.442zM12.386 4.134a.52.52 0 100-1.041.52.52 0 000 1.041z" fill="#757575"/></svg></a>
                                    </Link>
                                </li>
                            </ul>
                        </div>
