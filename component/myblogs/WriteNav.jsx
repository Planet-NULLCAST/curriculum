              ...
              <div className="flex flex-col p-5">
                ...
                <div className="w-full mt-5">
                  ...
                  <div className="flex w-full border rounded overflow-hidden">
                    <div className="w-1/2 border border-black text-white bg-black h-10 flex justify-center items-center text-sm">
                      Nullcast.io/
                    </div>
                    <input
                      type="text"
                      className="w-1/2 m-0 outline-none focus:outline-none px-2 text-sm bg-gray-100"
                      placeholder="Enter URL"
                    />
                  </div>
                </div>
                <div className="w-full mt-5">
                  <div className="w-full m-0 h-10 outline-none focus:outline-none px-2 text-sm bg-gray-100 border rounded flex items-center text-gray-500 cursor-pointer">
                    Tags
                  </div>
                  <div className="flex flex-wrap mt-1">
                    <div className="bg-gray-200 flex items-center px-3 py-1 rounded-xl">
                      <span className="mr-1 text-xs">HTML</span>
                      <svg
                        width="8"
                        height="8"
                        viewBox="0 0 12 12"
                ...
                <div className="w-full mt-5">
                  <textarea
                    rows="3"
                    className="w-full m-0 outline-none focus:outline-none p-2 text-sm bg-gray-100 border rounded"
                    placeholder="Description"
                  />
                </div>
              </div>
              <div className="absolute bottom-0 left-0 w-full px-5 bg-white pt-3">
                <div className="w-full flex mb-3">
                  <div className="w-1/2 pr-1">
                    <button className="w-full border border-black text-white hover:text-black bg-black hover:bg-white flex justify-center items-center h-10 duration-700 rounded text-sm">
                      Save
                    </button>
                  </div>
                  <div className="w-1/2 pl-1">
                    <button
                      className="w-full border border-black text-black hover:text-white bg-white hover:bg-black flex justify-center items-center h-10 duration-700 rounded text-sm"
                      onClick={() => setopenSettings(false)}
                    >
                      Cancel
                    </button>
