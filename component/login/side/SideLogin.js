...
export default function Login() {
  return (
    <div
      className={`w-1/2 h-full hidden lg:flex flex-col items-center justify-center p-20 text-center fixed left-0 top-0 h-screen ${Loginstyles.bg_yellow_710} ${Loginstyles.duck_login}`}
    >
      <img
