...
export default function paginationLeaderBoard({ TotalCount, changePage, pageNum, limit }) {
        ...
        <div className="bg-white h-12 flex justify-center w-full items-center rounded border">
          <div className="flex flex-col items-center my-12">
            <div className="flex text-gray-700">
              <div
                className={`h-8 w-8 mr-1 flex justify-center items-center rounded-full ${pageNo === 1
              ...
              <div className="flex h-8 font-medium rounded-full">
                <div className="flex h-8 font-medium rounded-full ">
                  ...
                  {LastThree[0] && (
                    <div
                      className={`w-8 mx-2 md:flex justify-center items-center hidden font-semibold  cursor-pointer leading-5 transition duration-150 ease-in  rounded-full  hover:text-gray-500  ${pageNo === LastThree[0] && "text-white bg-black"
                        }`}
                      onClick={() => {
              ...
              <div
                className={`h-8 w-8 mr-1 flex justify-center items-center rounded-full ${pageNo === TotalPages
                  ? `${Styles.arrowStyleDisabled} cursor-not-allowed`
                  : `${Styles.arrowStyle}  cursor-pointer  hover:bg-black`
                  }  `}
                onClick={() => {
